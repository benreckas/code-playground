...
var globals = {
  ...
  /** Methods */
  toggleContentLoadState: function toggleContentLoadState() {
    this.contentLoader.classList.toggle('hidden');
  },
  toggleInputLoadState: function toggleInputLoadState() {
    this.inputLoader.classList.toggle('hidden');
  },
  toggleInputDisabledState: function toggleInputDisabledState() {
    this.itemSelect.toggleAttribute('disabled');
  },
  resetItemSelect: function resetItemSelect() {
...
/*!*****************************!*\
  !*** ./app/js/resources.js ***!
  \*****************************/
/*! exports provided: StarWarsResource, Person, Film, Starship, Vehicle, Species, Planet */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StarWarsResource", function() { return StarWarsResource; });
...
/* harmony import */ var _globals__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./globals */ "./app/js/globals.js");
...
var StarWarsResource =
/*#__PURE__*/
function () {
  function StarWarsResource() {
    _classCallCheck(this, StarWarsResource);
  }
...
function (_StarWarsResource) {
  ...
  _createClass(Person, [{
    ...
    value: function () {
      ...
      function _createFilmHtml() {
        return _createFilmHtml2.apply(this, arguments);
      }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _sass_styles_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../sass/styles.sass */ "./app/sass/styles.sass");
...
/* harmony import */ var _globals__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./globals */ "./app/js/globals.js");
/* harmony import */ var _resources__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./resources */ "./app/js/resources.js");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
...
function _getResource() {
  _getResource = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(e) {
    var resource, url, response, data;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            resource = _globals__WEBPACK_IMPORTED_MODULE_2__["default"].resourceSelect.selectedOptions[0].dataset.resource;
            url = e.target.selectedOptions[0].dataset.url;
            _globals__WEBPACK_IMPORTED_MODULE_2__["default"].content.innerHTML = '';
            _globals__WEBPACK_IMPORTED_MODULE_2__["default"].toggleContentLoadState();
            _context.prev = 4;
            _context.next = 7;
            return fetch(url, _globals__WEBPACK_IMPORTED_MODULE_2__["default"].fetchOptions);
          ...
          case 10:
            data = _context.sent;
            _globals__WEBPACK_IMPORTED_MODULE_2__["default"].toggleContentLoadState(); // eslint-disable-next-line default-case

            _context.t0 = resource;
            _context.next = _context.t0 === 'person' ? 15 : _context.t0 === 'film' ? 16 : _context.t0 === 'starship' ? 17 : _context.t0 === 'vehicle' ? 18 : _context.t0 === 'species' ? 19 : _context.t0 === 'planet' ? 20 : 21;
            break;

          case 15:
            return _context.abrupt("return", new _resources__WEBPACK_IMPORTED_MODULE_3__["Person"](data));

          case 16:
            return _context.abrupt("return", new _resources__WEBPACK_IMPORTED_MODULE_3__["Film"](data));

          case 17:
            return _context.abrupt("return", new _resources__WEBPACK_IMPORTED_MODULE_3__["Starship"](data));

          case 18:
            return _context.abrupt("return", new _resources__WEBPACK_IMPORTED_MODULE_3__["Vehicle"](data));

          case 19:
            return _context.abrupt("return", new _resources__WEBPACK_IMPORTED_MODULE_3__["Species"](data));

          case 20:
            return _context.abrupt("return", new _resources__WEBPACK_IMPORTED_MODULE_3__["Planet"](data));
          ...
          case 23:
            ...
            console.log(_context.t1); // eslint-disable-line no-console
...
function addResultToSelect(_x2) {
  return _addResultToSelect.apply(this, arguments);
}

function _addResultToSelect() {
  _addResultToSelect = _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _globals__WEBPACK_IMPORTED_MODULE_2__["default"].itemSelect.appendChild(option);
...
function getSelectedResource(_x3) {
  return _getSelectedResource.apply(this, arguments);
}

function _getSelectedResource() {
  _getSelectedResource = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee3(url) {
    var response, _ref, results, next;
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 6:
            ...
            results.forEach(function (result) {
              return addResultToSelect(result);
            });
            ...
            return _context3.abrupt("return", getSelectedResource(next));

          case 12:
            _globals__WEBPACK_IMPORTED_MODULE_2__["default"].toggleInputLoadState();
            _globals__WEBPACK_IMPORTED_MODULE_2__["default"].toggleInputDisabledState();
            _globals__WEBPACK_IMPORTED_MODULE_2__["default"].itemSelect.addEventListener('input', getResource);
            _context3.next = 20;
            break;
...
function _selectResource() {
  _selectResource = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee4(e) {
    var _e$target$selectedOpt, url, label;

    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _e$target$selectedOpt = e.target.selectedOptions[0].dataset, url = _e$target$selectedOpt.url, label = _e$target$selectedOpt.label;
            getSelectedResource(url);
            _globals__WEBPACK_IMPORTED_MODULE_2__["default"].itemLabel.textContent = "Choose a ".concat(label);
            _globals__WEBPACK_IMPORTED_MODULE_2__["default"].resetItemSelect();
            _globals__WEBPACK_IMPORTED_MODULE_2__["default"].toggleInputLoadState();
...
window.onload = function () {
  return _globals__WEBPACK_IMPORTED_MODULE_2__["default"].resourceSelect.addEventListener('input', selectResource);
};
...
var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!../../node_modules/sass-loader/lib/loader.js!./styles.sass */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/lib/loader.js!./app/sass/styles.sass");
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/lib/loader.js!./app/sass/styles.sass":
/*!*************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/lib/loader.js!./app/sass/styles.sass ***!
  \*************************************************************************************************************/
/*! no static exports found */
